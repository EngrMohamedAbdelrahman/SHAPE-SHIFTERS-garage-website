...
<body>
	...
	<section id="signup" class="d-flex align-items-center justify-content-center">
		...
		<div class="container" data-aos="fade-up">
			<h1 style="color:#e0dede;">Brake Services</h1>
			<br>
...
if(empty($_POST['date_op'])){
	...
	$sql = "INSERT INTO serv_brake (serv_id,serv_name,stat,user_id,user_name,customer_contact,car_type,
