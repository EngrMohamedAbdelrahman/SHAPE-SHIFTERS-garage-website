...
<body>
	...
	<section id="signup" class="d-flex align-items-center justify-content-center">
		...
		<div class="container" data-aos="fade-up">
			<h1 style="color:#e0dede;">Rims Services</h1>
			<br>
						...
						<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data" class="order">
							<h4>
								<fieldset>
									...
									<h4 style="text-align:left;  color:white;">Service Type</h4>
									<div class="row">								
										<div class="col-4">
											<label style="color:white; font-size:20px">Change Rim Color</label>
											<input type="radio" name="Service_Type" value="Change Rim Color">
										</div>
										<div class="col-4">

											<label style="color:white; font-size:20px">Change Rim Style</label>
											<input type="radio" name="Service_Type" value="Change Rim Style">
										</div>
										<div class="col-4">

											<label style="color:white;font-size:20px">Fix Rim</label>
											<input type="radio" name="Service_Type" value="Fix Rim">
										</div>
									</div>
...
//////////////////////////////////////////////////
	...
	$sql = "INSERT INTO serv_rims (serv_id,serv_name,stat,user_id,user_name,customer_contact,car_type,
	car_model, Service_Type,payment_method,delivery,pickup,date_op,time_op,loction_op,image_name) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
