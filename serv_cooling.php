...
<head>
	<meta charset="UTF-8">
	<title>Cooling System and Radiatar Services</title>
...
<body>
	...
	<section id="signup" class="d-flex align-items-center justify-content-center">
		...
		<div class="container" data-aos="fade-up">
			<h1 style="color:#e0dede;">Cooling System and Radiatar Services</h1>
			<br>
						...
						<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data" class="order">
							<h4>
								<fieldset>
									...
									<h4 style="text-align:left;  color:white;">Details</h4>
...
if (($_SERVER["REQUEST_METHOD"] == "POST") && (!($_POST['car_type']==null))&&(!($_POST['car_model']==null)))
{
	
	$serv_id="03";
	$serv_name="Cooling System and Radiatar Services";
...
//////////////////////////////////////////////////
	...
	$sql = "INSERT INTO serv_cooling (serv_id,serv_name,stat,user_id,user_name,customer_contact,car_type,
	car_model, details,payment_method,delivery,pickup,date_op,time_op,loction_op,image_name) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
