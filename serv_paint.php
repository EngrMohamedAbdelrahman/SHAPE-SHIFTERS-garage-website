...
<head>
	<meta charset="UTF-8">
	<title>Paint Job Services</title>
...
<body>
	...
	<section id="signup" class="d-flex align-items-center justify-content-center">
		...
		<div class="container" data-aos="fade-up">
			<h1 style="color:#e0dede;">Paint Job Services</h1>
			<br>
						...
						<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST"  enctype="multipart/form-data" class="order">
							<h4>
								<fieldset>
									...
									<h4 style="text-align:left;  color:white;">Color</h4>
<div class="row">
<div class="col-1">
...
<label  style="color:white; font-size:20px">Pangea Green</label>
										<input type="radio"  name="color" value="Pangea Green">
</div>
<div class="col-2">

<label  style="color:white; font-size:20px">Gondwana Stone</label>
										<input type="radio"  name="color" value="Gondwana Stone">
</div>
<div class="col-2">

<label  style="color:white;font-size:20px">Eiger Grey</label>
										<input type="radio"  name="color" value="Eiger Grey">
</div>
<div class="col-2">

<label  style="color:white;font-size:20px">Hakuba Silver</label>
										<input type="radio"  name="color" value="Hakuba Silver">
</div>
<div class="col-2">

<label style="color:white;font-size:20px">Tasman Blue</label>
										<input type="radio"  name="color" value="Tasman Blue">
</div>
...
//////////////////////////////////////////////////
	...
	$sql = "INSERT INTO serv_paint (serv_id,serv_name,stat,user_id,user_name,customer_contact,car_type,
	car_model, color,payment_method,delivery,pickup,date_op,time_op,loction_op,image_name) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	
	if($stmt = $conn->prepare($sql)){
		// Bind variables to the prepared statement as parameters
		$stmt->bind_param("ssssssssssssssss",$param_serv_id,
		$param_serv_name ,
		$param_stat ,
		$param_user_id,
		$param_user_name ,
